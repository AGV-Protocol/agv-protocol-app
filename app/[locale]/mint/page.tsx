...
export default function MintPage() {
  const t = useTranslations('minting');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#223256] via-[#223256] to-[#223256]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
          ...
          <div className="text-center space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 lg:gap-6">
              <div className="flex items-center gap-2 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 rounded-lg bg-[#4ade80] border border-[#4ade80]">
                ...
                <span className="text-white font-medium text-sm sm:text-base">{t('liveMinting')}</span>
              </div>
              <div className="flex items-center gap-2 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 rounded-lg bg-[#4ade80] border border-[#4ade80]">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span className="text-white font-medium text-sm sm:text-base">{t('multiChain')}</span>
              </div>
              <div className="flex items-center gap-2 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 rounded-lg bg-[#4ade80] border border-[#4ade80]">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span className="text-white font-medium text-sm sm:text-base">{t('usdtPayment')}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Minting Interface */}
        <div>
          <Suspense fallback={<div className="text-white text-center py-6 sm:py-8 text-sm sm:text-base">{tCommon('loading')}</div>}>
      ...
      {/* Footer */}
      <Footer
        backgroundClass="bg-gradient-to-br from-[#223256] via-[#223256] to-[#223256]"
