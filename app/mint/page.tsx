...
export default function MintPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#223256] via-[#223256] to-[#223256]">
        ...
        <div className="relative overflow-hidden rounded-2xl border p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 shadow-lg max-w-6xl mx-auto bg-[#223256] border-white/10">
          <div className="text-center space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 lg:gap-6">
              <div className="flex items-center gap-2 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 rounded-lg bg-green-500/20 border border-green-500/30">
      ...
      {/* Footer */}
      <Footer backgroundClass="bg-gradient-to-br from-[#223256] via-[#223256] to-[#223256]" textColorClass="text-white" />
    </div>
  );
}
